meta =
{
    ...
    description = "Faction relations, wars, conquest pressure, and battle escalation systems for Avorion. Built as a companion to Cosmic Overhaul.",
    ...
    -- },
    dependencies = {
        {id = "Avorion", min = "1.0", max = "10.0"},
        {id = "3674093144", min = "1.0.0"}
    },
