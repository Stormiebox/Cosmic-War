...
-- completion trigger below checks raw current stock. The live counter shows that same raw
-- current stock, staying consistent with what actually completes the contract. See
-- cw_scorched_earth.lua's own updateServer for why this hook is guaranteed server-only and how
-- often it polls.
