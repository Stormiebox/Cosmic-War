...
function getBulletin(station)
    ...
    return {
        ...
        description = "Our experimental hyperspace weapons have torn a rift in sector (${location.x}:${location.y}). Ancient structures have emerged. Destroy them and secure the zone."%_T,
