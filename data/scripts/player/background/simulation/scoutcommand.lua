...
local __CW_scout_calculatePrediction_original = ScoutCommand.calculatePrediction

function ScoutCommand:calculatePrediction(ownerIndex, shipName, area, config)
    local prediction = __CW_scout_calculatePrediction_original(self, ownerIndex, shipName, area, config)
