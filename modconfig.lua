            ...
            options = {
                {
                    ...
                    description = "How often war bulletins are generated.",
                    default = 420,
                    min = 60,
                    max = 3600,
                },
                {
                    ...
                    description = "How often diplomatic sanctions are evaluated.",
                    default = 600,
                    min = 60,
                    max = 3600,
                },
                {
                    ...
                    description = "How often ceasefire/détente opportunities are evaluated.",
                    default = 900,
                    min = 60,
                    max = 7200,
                },
                {
                    ...
                    description = "How often war bounties are refreshed.",
                    default = 600,
                    min = 60,
                    max = 3600,
                },
                {
                    ...
                    description = "Base chance for applying sanctions in active rivalries.",
                    default = 35,
                    min = 0,
                    max = 100,
                    step = 1,
                ...
                },
                {
                    ...
                    description = "Base chance for ceasefire resolution when relations recover.",
                    default = 25,
                    min = 0,
                    max = 100,
                    step = 1,
            ...
            options = {
                {
                    ...
                    description = "Applies war-heat effects to economic predictions (e.g. trade profit/risk).",
                    default = true,
                },
                {
                    ...
                    description = "Applies war-heat captain risk/reward modifiers to simulation command predictions.",
                    default = true,
                },
            },
        },
